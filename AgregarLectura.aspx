        ...
        <div class="col-lg-6 mx-auto">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <asp:rangevalidator errormessage="Ingresa una hora valida (Horario 24 horas)" forecolor="Red" controltovalidate="hora" minimumvalue="0" maximumvalue="24" runat="server">
            </asp:rangevalidator>
                    <asp:rangevalidator errormessage="Ingrese Minutos Validos" forecolor="Red" controltovalidate="minutos" minimumvalue="0" maximumvalue="59" runat="server">
            </asp:rangevalidator>
